# TP 5 : LangGraph Studio et Systèmes Multi-Agents

**Master BDCC — SMA et IAD | Prof. RETAL SARA**

## Objectif pédagogique

Ce laboratoire regroupe deux travaux pratiques complémentaires basés sur LangGraph Studio :

1. **Visualiser, tester et déboguer un agent** avec LangGraph Studio — visualiser le graphe d'un agent, l'exécuter étape par étape, inspecter les entrées/sorties de chaque nœud ;
...
├── agent_simple.py      # TP 5 : agent avec outil RAG simulé
├── multi_agents.py      # TP 8 : agent principal + 2 sous-agents
...
## Partie 2 — Agent simple avec outil RAG
...
## Partie 3 — Configuration LangGraph Studio (`langgraph.json`)
...
## Partie 4 — Lancer LangGraph Studio
...
- Le graphe de l'agent avec les nœuds `model` et `tools`
...
# Partie 5 : Systèmes Multi-Agents Hiérarchiques
