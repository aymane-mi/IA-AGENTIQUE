# TP 4 : Model Context Protocol (MCP)
...
**Résultat attendu :** L'agent récupère dynamiquement les tools/resources/prompts du serveur MCP, effectue une recherche web et répond à la question.
...
Utilise le package `mcp-server-time` pour exposer l'heure en temps réel par fuseau horaire.
...
| `mcp-server-time` | Serveur MCP de temps (fuseau horaire) |
